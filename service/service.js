...
const elementRepoClient = require('../transpiler/element-repo-client');
...
const deafultSchematicPath = "C:/Users/Lauki/Documents/Git/magic-tool/transpiler/schematics/ng-utils";
const deafultElementRepoURL = "http://localhost:4000";
...
class MagicService {
    ...
    entryPoint(args) {
        ...
        const schematicPath = args[5] || process.env.SCHEMATICPATH || deafultSchematicPath;
        const repoURL = args[6] || process.env.ELEMENTREPOURL || deafultElementRepoURL;
        ...
        this._dependencyContainer.register(serviceNames.ElementsRepoClient, new elementRepoClient(repoURL));
